# Cloud9 Web IDE
Docker hub: https://hub.docker.com/r/jrcamenzuli/cloud9-nodejs/
...
## Usage
    ...
    docker run -d -v $(pwd):/workspace -p 8181:8181 jrcamenzuli/cloud9-nodejs[:tag]

## Start with auth

    docker run -d -v $(pwd):/workspace -p 8181:8181 jrcamenzuli/cloud9-nodejs[:tag] --auth username:password
    
You can also use any starting option describe in : https://github.com/c9/core

## Use custom user settings

    docker run -d -v $(pwd):/workspace -v /home/user/c9.settings:/root/.c9/user.settings -p 8181:8181 jrcamenzuli/cloud9-nodejs[:tag]
